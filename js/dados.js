var MENU = {
    "churrasco": [
        {
            "id": "batata-frita",
            "img": "./img/cardapio/churrasco/batata-frita.jpg",
            "name": "Batata Frita - 500g",
            "dsc": "Joe's KC Ribs, Brisket & Burnt Ends",
            "price": 18.00
        },
        {
            "id": "meia-batata-frita",
            "img": "./img/cardapio/churrasco/meia-batata-frita.jpg",
    ...
    "burgers": [
        {
            "id": "frango-inteiro",
            "img": "./img/cardapio/burguers/frango-inteiro.jpg",
            "name": "Frango inteiro",
            "dsc": "Frango Assado",
            "price": 35
        },
        {
            "id": "frango-cortado",
            "img": "./img/cardapio/burguers/frango-cortado.jpg",
            "name": "Frango Cortado",
            "dsc": "Frango Assado",
            "price": 35
        },
        {
            ...
            "img": "./img/cardapio/burguers/frango-com-batata.jpg",
            "name": "Frango int. s/ batatas",
            "dsc": "Frango Assado",
            "price": 35
        }
    ...
    "bebidas": [
        {
            "id": "coca-cola",
            "img": "./img/cardapio/bebidas/coca-cola.jpg",
            "name": "Coca-Cola 2L",
        ...
        {
            "id": "kuat",
            "img": "./img/cardapio/bebidas/kuat.jpg",
            "name": "Kuat 2L - S/ Açúcar",
            "dsc": "Guy's Caliente Margaritas for 12",
            "price": 10.00
        },
        {
            "id": "guaraná-antártica",
            "img": "./img/cardapio/bebidas/guaraná antártica.jpg",
    ...
    "pizzas": [ /* Salpicão */
        {
            "id": "salpicao-500g",
            "img": "./img/cardapio/pizzas/salpicao-500g.jpg",
            "name": "Salpicão - 500g",
        ...
        {
            "id": "salpicao-250g",
            "img": "./img/cardapio/pizzas/salpicao-250g.jpg",
            "name": "Salpicão - 250g",
            "dsc": "2 Lou Malnati's Deep Dish Pizzas",
            "price": 9.00
        },
    ...
    "steaks": [  /* Acompanhamentos */
        {
            "id": "arroz-3pessoas",
            "img": "./img/cardapio/steaks/arroz-3pessoas.jpg",
            "name": "Arroz(3 Pessoas)",
       ...
       /*  {
        ...
        {
            "id": "linguiça-pernil",
            "img": "./img/cardapio/steaks/linguiça-pernil.jpg",
            "name": "Ling. Pernil (Unidade)",
            "dsc": "Steaks and Cakes Date Night Dinner for 2",
            "price": 3.00
        },
